...
// Mapping trạng thái thành nhãn thân thiện
const statusLabels = {
  PENDING: 'Pending',
            ...
            <div className="grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-1">
              ...
              <div>
                ...
                <div className="mt-0.5 flex items-center">
                  <div
                    className={`inline-flex items-center justify-center flex-shrink-0 w-3 h-3 rounded-full text-white ${statusColors[order.orderStatus] || 'bg-gray-400'
                      } mr-1.5`}
                  >
                    <svg
                      className="w-2 h-2"
                  ...
                  <div className="flex flex-col justify-between flex-1 ml-5">
                    <div className="sm:grid sm:grid-cols-2 sm:gap-x-5">
                      ...
                      <div className="mt-4 sm:mt-0 flex items-center justify-between">
                        <p className="me-4 text-sm font-medium text-gray-500">
                          {item.quantity}
                        </p>
