    ...
    return (
        <div className="max-w-2xl mx-auto p-4 bg-white rounded-lg shadow-md text-black">
            <div className="space-y-4">
                ...
                <div className="flex border-b py-2">
                    <span className="font-semibold w-1/3">Farmer Code:</span>
                ...
                <div className="flex border-b py-2">
                    <span className="font-semibold w-1/3">Contact Phone:</span>
                    <span className="w-2/3">{farmer?.farmerProfile?.contactPersonPhone || 'Not provided'}</span>
                </div>
                <div className="flex border-b py-2">
