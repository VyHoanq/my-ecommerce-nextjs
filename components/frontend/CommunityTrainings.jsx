...
export default async function CommunityTrainings({ trainings, title }) {
  ...
  return (
    <section className="py-12 bg-white rounded-md shadow-lg sm:py-16">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className=" mx-auto md:mx-0">
          <div className="flex items-center justify-between">
            ...
            <Link href="/blogs" className='bg-black py-3 px-5 rounded text-white flex items-center'>See All <MoveRight className='flex-shrink-0 mx-2' /> </Link>
          </div>
