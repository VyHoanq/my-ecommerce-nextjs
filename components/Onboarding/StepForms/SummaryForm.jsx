...
export default function SummaryForm(farmerId) {
  ...
  async function submitData() {
    ...
    console.log(data);
    makePostRequest(setLoading, "api/farmers", data, "Seller Profile", reset, redirect);
  }
  ...
  return (
    <div>
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        {
          loading ? (
            <button disabled className="inline-flex items-center px-6 py-3 mt-4 sm:mt-6 test-sm font-medium text-center text-white bg-purple-900 rounded-lg focus:ring-4 focus:ring-blue-200 hover:bg-purple-800">Processing Please wait....</button>
          ) : (
            <button
              onClick={submitData}
              type="submit"
